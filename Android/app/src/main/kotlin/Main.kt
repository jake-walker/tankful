...
internal val logger: SkipLogger = SkipLogger(subsystem = "tankful.app", category = "TankfulApp")

private typealias AppRootView = TankfulAppRootView
private typealias AppDelegate = TankfulAppAppDelegate
